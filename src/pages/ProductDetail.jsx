  ...
  return (
    <>
      <div className="flex items-center justify-between w-full px-4 h-14">
        ...
        <p className="line-clamp-1 w-[50%] text-center">{product.title}</p>
      ...
      <div className="mt-2 ">
        <div className="px-4">
          ...
          <div className="flex items-center mt-2">
            ...
            <div className="flex items-center justify-center p-2 border border-gray-400 rounded-md gap-[6px] ml-4">
        ...
        <div className="px-4 mt-4 border-y-8">
          ...
          <div className="flex justify-between border-y py-[6px]">
            ...
            <p className="w-[50%] text-xs capitalize font-bold text-primary">{product.category}</p>
          </div>
      ...
      <div className="fixed flex justify-center items-center bottom-0 py-[10px] bg-white w-full shadow-[0px_-1px_12px_10px_#00000024]">
        <button
